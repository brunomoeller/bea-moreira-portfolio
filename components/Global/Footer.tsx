...
export default function Footer({}: Props) {
  ...
  return (
    <motion.footer
      ...
      className={`col-span-12 grid grid-cols-2 grid-rows-2  gap-y-2 md:gap-y-4 items-center justify-items-center md:justify-items-start md:justify-start mt-60 md:mt-72 md:pb-14 pb-4 border-b border-b-[#2E2D2D] ${quicksand.variable} ${poppins.variable} font-poppins`}
    >
      <div className="grid md:row-span-full col-span-2 self-center justify-items-center md:justify-items-start md:self-start gap-y-5">
        <h3 className="text-3xl text-center md:text-5xl md:text-start text-darker-white font-quicksand">
          {t("cta")}
        </h3>
        <Link
          href="mailto:beatrizmoreira.pd@gmail.com"
      ...
      <div className="col-span-2 md:col-start-2 md:place-self-end md:self-end flex justify-end gap-x-6">
        <Link target="_blank" rel="noopener noreferrer" href="https://www.behance.net/beatrizmoreira3">
          <Image src={behance} alt="behance" />
        </Link>
        <Link target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/msbeatriz/">
